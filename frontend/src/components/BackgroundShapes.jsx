  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none select-none z-0">
      ...
      <svg className="absolute inset-0 w-full h-full text-white pointer-events-none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g className="opacity-[0.05] origin-[80%_20%] animate-[spin_100s_linear_infinite]" style={{ transformOrigin: '80% 20%' }}>
        ...
        <g className="opacity-[0.04] origin-[20%_80%] animate-[spin_180s_linear_infinite_reverse]" style={{ transformOrigin: '20% 80%' }}>
          ...
          <g transform="translate(-100, -100)">
            ...
            <line x1="20%" y1="80%" x2="23%" y2="92%" stroke="currentColor" strokeWidth="1.5" />
          </g>
        </g>

        {/* Engineering Crosshairs / Cad Grid Markings */}
        <g className="opacity-[0.06] text-amber-500">
        ...
        <g className="opacity-[0.04] text-amber-500 origin-[85%_75%] animate-[spin_150s_linear_infinite]" style={{ transformOrigin: '85% 75%' }}>
